...
const parnterController = {
    ...
    listall: async (req, res) => {
        try {
            ...
            // Only apply tenantName search if user entered something
            ...
            // Filter by currentState
            if (searchStatus) {
                whereCondition.AND.push({
                    currentState: searchStatus
                });
            }
...
module.exports = parnterController;
